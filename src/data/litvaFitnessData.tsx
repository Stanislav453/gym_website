import zborovMap from '../assets/map/litva-fitness-zborov.webp';
import bystricaMap from '../assets/map/litva-fitness-stara-bystrica.webp';

export const litvaFitnessData = {
  title: 'litva fitness',
  ...
  servicesData: [
    ...
    },
    {
      ...
      servicesCategory: [
        {
          categoryTitle: 'Jednorázová spolupráca',
          list: [
            'kompletná diagnostika(osobné stretnutie)',
            'vopred sa dohodneme, čo očakávate a ja podľa toho urobím tréningovú jednotku',
            'počas tréningu sú klientovi vysvetlené všetky cviky, technika, prevedenie, správne dýchanie, príp. nejasnosti /otázky',
            '1x osobný tréning',
          ],
          price: 'CENA 20 EUR / tréningová jednotka.',
        },
        {
          categoryTitle: 'V prípade dlhodobej spolupráce',
          list: [
          ...
          price: '10x osobný tréning : CENA 150EUR / 2x týždenne',
          sale: '15x osobný tréning : CENA 190EUR / 3x týždenne',
          alertInfo:
  ...
  location: [
    {
      title: 'Zborov nad Bystricou',
      link: 'https://maps.app.goo.gl/BDMiSH44mDWfDcLB8',
      img: zborovMap,
    },
    {
      title: 'Stará Bystrica',
      link: 'https://maps.app.goo.gl/8UjUTRdBm3CvVtDa9',
      img: bystricaMap,
    },
  ],
};
